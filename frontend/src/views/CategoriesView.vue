    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="group cursor-pointer">
          ...
          <h3 class="font-bold text-lg text-black mb-2">Albums</h3>
          <p class="text-gray-600">Latest K-pop album releases and limited editions</p>
        ...
        <div class="group cursor-pointer">
          ...
          <h3 class="font-bold text-lg text-black mb-2">Merchandise</h3>
          <p class="text-gray-600">T-shirts, hoodies, accessories and more</p>
        ...
        <div class="group cursor-pointer">
          ...
          <h3 class="font-bold text-lg text-black mb-2">Posters</h3>
          <p class="text-gray-600">Official posters, prints and wall art</p>
        ...
        <div class="group cursor-pointer">
          ...
          <h3 class="font-bold text-lg text-black mb-2">Collectibles</h3>
          <p class="text-gray-600">Photocards, figurines and limited collectibles</p>
        ...
        <div class="group cursor-pointer">
          ...
          <h3 class="font-bold text-lg text-black mb-2">Accessories</h3>
          <p class="text-gray-600">Bags, belts, hats and fashion accessories</p>
        ...
        <div class="group cursor-pointer">
          ...
          <h3 class="font-bold text-lg text-black mb-2">Media</h3>
          <p class="text-gray-600">DVDs, Blu-rays and concert recordings</p>
          <a href="#" class="text-black font-semibold mt-4 inline-block hover:underline">Browse Media →</a>
        </div>
      </div>
    </div>
  </div>
