  ...
  <div class="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-8">
    <div class="w-full max-w-md">
      <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <Form :validation-schema="signupValidationSchema" @submit="onSubmit" class="space-y-4">
              ...
              <div>
                ...
                <Field name="name" v-slot="{ field, meta }">
                  ...
                  />
                  <ErrorMessage name="name" class="text-xs text-red-500 mt-1 block" />
                </Field>
              </div>
              ...
              <div>
                ...
                <Field name="confirmPassword" v-slot="{ field, meta }">
                  ...
                  <ErrorMessage name="confirmPassword" class="text-xs text-red-500 mt-1 block" />
                </Field>
              </div>
...
import { signupValidationSchema } from '@/modules/admin/utils'
