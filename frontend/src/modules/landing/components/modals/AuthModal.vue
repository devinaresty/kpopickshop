  ...
  >
    ...
    >
      <div class="hidden sm:flex flex-col items-center justify-center p-8 lg:p-10 bg-gradient-to-br from-gray-50 to-gray-100">
        <img src="/logo (4).png" alt="K Logo" class="w-28 h-28 lg:w-32 lg:h-32 object-contain mb-6" />
      ...
      <div class="flex flex-col">
        <div class="flex justify-between items-center p-4 sm:p-5 lg:p-6 border-b border-gray-100 sm:border-b-0">
          <img src="/logo (4).png" alt="K Logo" class="sm:hidden w-14 h-14 object-contain" />
          <h2 class="sm:hidden text-sm font-bold text-black">KPopick</h2>
          
          <button
            @click="landingStore.closeAuthModal()"
            class="text-gray-400 hover:text-gray-600 transition-colors ml-auto"
          >
        ...
        <div class="p-5 sm:p-6 lg:p-7 flex-grow flex flex-col">
          ...
          <div class="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-100">
            <button
              ...
              class="w-full text-xs sm:text-sm text-center text-gray-600 hover:text-black transition-colors font-medium"
            >
            ...
            >
              <button
                class="flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
              >
